class HeroCardView {
  render(loginData, userDetails) {
    ...
    linear-gradient(to left, rgba(32, 32, 32, 0), rgba(32, 32, 32, 0), rgba(32, 32, 32, 0)),  url('https://raw.githubusercontent.com/rivSpades/Gambloors/master/src/img/banner-bg-4.png')`;
